function mProcess_LocalGlobal_MouseRHD(ROOTPATH, protStr, date)
%% Load data
...
%     end
    ...
    LocalGlobalParams               = MouseLA_ParseLocalGlobalParams(protStr(pIndex));
    LocalGlobalParams.Window        = evalin('base', 'spkSelect_Window');
    trialAll{pIndex, 1}      = PassiveProcess_LocalGlobalTempSpec_RHD(data.epocs);
    trialAll{pIndex, 1} (1)  = [];
